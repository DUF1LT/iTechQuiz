...
namespace iTechArt.iTechQuiz.Repositories.Migrations
{
    ...
    [Migration("20220112151143_init domain models structure")]
    partial class initdomainmodelsstructure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iTechArt.iTechQuiz.Domain.Models.User<System.Guid>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("iTechArt.iTechQuiz.Domain.Models.User<System.Guid>", null)
                        .WithMany()
            ...
            modelBuilder.Entity("iTechArt.iTechQuiz.Domain.Models.Answer", b =>
                {
                    ...
                    b.HasOne("iTechArt.iTechQuiz.Domain.Models.User<System.Guid>", "User")
                        .WithMany("Answers")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("iTechArt.iTechQuiz.Domain.Models.Survey", b =>
                {
                    b.HasOne("iTechArt.iTechQuiz.Domain.Models.User<System.Guid>", "Founder")
                        .WithMany("Surveys")
